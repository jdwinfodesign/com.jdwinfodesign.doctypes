...
<!--                    LONG NAME: Chapter                         -->
<!--           jdw 07-26-2022 adds exhibit topicref specialization -->
...
<!--                    LONG NAME: Exhibit                         -->
<!--        jdw 07-26-2022 exhibit is a specialized topicref       -->
<!ELEMENT  exhibit %topicref.content;>
<!ATTLIST  exhibit %topicref.attributes;>
...
<!--                    LONG NAME: Appendix                        -->
<!--           jdw 07-26-2022 adds exhibit topicref specialization -->
<!--           jdw 08-10-2022 adds appendix-reference topicref specialization -->
<!ENTITY % appendix.content
                       "(
                       (%topicmeta;)?,
                       (appendix-reference | appendix-ref-num)*,
                       (%topicref;)*, 
                       (exhibit)*)"
>
...
<!--                LONG NAME: Appendix Reference Table Topic            -->
<!--        jdw 08-10-2022 appendix-reference is a specialized topicref  -->
<!ELEMENT  appendix-reference %topicref.content;>
<!ATTLIST  appendix-reference %topicref.attributes;>

<!--                LONG NAME: Numbered Appendix Reference Table Topic   -->
<!--        jdw 08-10-2022 appendix-ref-num is a specialized topicref that 
                              includes the number of its parent appendix -->
<!ELEMENT  appendix-ref-num %topicref.content;>
<!ATTLIST  appendix-ref-num %topicref.attributes;>
...
<!--              jdw 07-27-2022 adding ATTLIST for exhibit topicref              -->
<!ATTLIST  exhibit      %global-atts;  class CDATA "- map/topicref bookmap/exhibit ">
<!--              jdw 08-10-2022 adding ATTLIST for appendix-reference topicref   -->
<!ATTLIST  appendix-reference      %global-atts;  class CDATA "- map/topicref bookmap/appendix-reference ">
<!--              jdw 08-10-2022 adding ATTLIST for appendix-ref-num topicref   -->
<!ATTLIST  appendix-ref-num      %global-atts;  class CDATA "- map/topicref bookmap/appendix-ref-num ">
<!-- ============================================================================ -->
